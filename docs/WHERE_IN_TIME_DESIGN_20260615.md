...
2. **1960s The Forester's Trail** [family bridge] — the generation of Greg's forester father (Cal Fire lineage); on-site oak milling (the real 30-year-aged oak in the cabin). Vane: crooked timber-claim / false survey speculator. (Corrected per canon 2026-06-15/24.)
...
**Author (new):** time-as-search-axis; the 1960s Forester's Trail + 1982 family eras; "future = another player's present" ledger-read; the consciousness-outside-spacetime narrator framing; Vane's per-era costume (same crime: forgery of presence).
