...
console.log('PlaceScene assets: canonical aliases, unsupported fallback, official embed/map coordinate parity, property-photo identity and fictional 1849 art PASS')
