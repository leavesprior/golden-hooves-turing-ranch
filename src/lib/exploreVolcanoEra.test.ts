...
ok(/eraName:\s*'The canvas camp'/.test(src), 'Volcano 1849 face is the canvas camp')
ok(/Brick Main Street comes later/.test(src), 'Volcano 1849 tagline is brick-later')
