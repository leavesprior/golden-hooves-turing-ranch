...
strip(volcanoGround, 5, 2, 18, '.')
strip(volcanoGround, 7, 0, 19, '~')
strip(volcanoGround, 7, 9, 11, '=')
...
const volcanoExterior: TownWalkMap = {
  ...
  notes: 'An authored camp in the limestone bowl: canvas, grass, creek and wooden markers. Paths, plank crossing and placements are invented for play, not a surveyed 1849 plan.',
  ...
  props: [
    ...
    prop('marker', 16, 2), prop('marker', 17, 2), prop('marker', 16, 3),
  ...
  targets: [
    ...
    { id: 'vol_cemetery', kind: 'attraction', attractionId: 'vol_cemetery', label: 'Look at the wooden markers', position: at(16, 3) },
