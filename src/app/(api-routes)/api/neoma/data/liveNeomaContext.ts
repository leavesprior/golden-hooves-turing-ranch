 ...
 *
 * Also exposes getTunnelStatus() — a lightweight tunnel/VPN + service
 * probe consumed by /api/neoma/health for monitoring and frontend mode
 * detection. Kept here so health and chat share one liveness module.
 */
...
/**
 * Tunnel/VPN + service status for live mode detection.
 * Stub implementation for production builds (full version on live branches).
 * Consumed by /api/neoma/health.
 */
