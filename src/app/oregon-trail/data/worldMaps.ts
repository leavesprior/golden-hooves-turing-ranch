...
export const GOLD_COUNTRY_LOCATIONS: MapLocation[] = [
  {
    ...
    dangerLevel: 'safe',
    connectedTo: ['sacramento_valley', 'mokelumne_hill', 'sandy_gulch', 'volcano'],
    travelTime: 4,
  ...
  },
  {
    ...
    dangerLevel: 'dangerous',
    connectedTo: ['west_point', 'san_andreas', 'jackson', 'chinese_tunnels'],
    travelTime: 3,
  ...
  },
  {
    ...
    services: ['saloon'],
    dangerLevel: 'dangerous',
    connectedTo: ['jackson', 'west_point', 'indian_grinding_rock', 'chinese_tunnels'],
    travelTime: 3,
