...
export type LocationType = 'town' | 'landmark' | 'fort' | 'river' | 'mine' | 'ghost_town' | 'pass' | 'spring' | 'mountains' | 'destination'
...
export const CHAPTER_1_WAYPOINTS: MapLocation[] = [
  ...
  },
  {
    ...
    dangerLevel: 'safe',
    connectedTo: ['south_pass', 'soda_springs'],
    travelTime: 6,
  ...
  },
  {
    ...
    lore: {
      founded: 'N/A',
      peakPopulation: 0,
      historicalNote: 'Natural carbonated springs. Emigrants marveled at the "soda water."',
      easterEggs: ['The spring water grants temporary luck bonus'],
    },
    services: [],
    dangerLevel: 'safe',
    connectedTo: ['fort_bridger', 'fort_hall'],
    travelTime: 5,
    description: 'Bubbling springs of naturally carbonated water refresh weary travelers.',
  },
  {
    id: 'fort_hall',
    name: 'Fort Hall',
    ...
    lore: {
      founded: '1834',
      peakPopulation: 300,
      historicalNote: 'Key junction where the Oregon and California Trails split.',
      easterEggs: ['A guide offers a shortcut... but can you trust him?'],
    },
    services: ['inn', 'shop', 'stable'],
    dangerLevel: 'safe',
    connectedTo: ['soda_springs', 'snake_river'],
    travelTime: 4,
    description: 'The parting of ways - Oregon or California?',
  },
  {
    id: 'snake_river',
    ...
    lore: {
      founded: 'N/A',
      peakPopulation: 0,
      historicalNote: 'One of the most treacherous river crossings. Many emigrant graves line the banks.',
      easterEggs: ['The ferryman mentions a suspicious character matching Black Bart'],
    },
    services: [],
    dangerLevel: 'dangerous',
    connectedTo: ['fort_hall', 'fort_boise'],
    travelTime: 6,
    description: 'The Snake River claims many lives. Choose your crossing wisely.',
  },
  {
    id: 'fort_boise',
    name: 'Fort Boise',
    ...
    lore: {
      founded: '1834',
      peakPopulation: 250,
      historicalNote: 'Hudson Bay Company trading post, later an emigrant rest stop.',
      easterEggs: ['A trader has items "from California" - suspiciously recent'],
    },
    services: ['shop', 'stable'],
    dangerLevel: 'safe',
    connectedTo: ['snake_river', 'blue_mountains'],
    travelTime: 5,
    description: 'A welcome rest before the mountain crossing.',
  },
  {
    id: 'blue_mountains',
    name: 'Blue Mountains',
    ...
    lore: {
      founded: 'N/A',
      peakPopulation: 0,
      historicalNote: 'Steep, forested terrain. Many wagons were lowered with ropes.',
      easterEggs: ['Native guides speak of gold in these mountains'],
    },
    services: [],
    dangerLevel: 'dangerous',
    connectedTo: ['fort_boise', 'the_dalles'],
    travelTime: 10,
    description: 'The last major mountain barrier before the promised land.',
  },
  {
    id: 'the_dalles',
    name: 'The Dalles',
    ...
    lore: {
      founded: '1850',
      peakPopulation: 1500,
      historicalNote: 'End of the overland trail. From here, emigrants rafted down the Columbia.',
      easterEggs: ['A riverboat captain knows shortcuts to Gold Country'],
    },
    services: ['inn', 'shop', 'stable', 'saloon'],
    dangerLevel: 'normal',
    connectedTo: ['blue_mountains', 'sacramento_valley'],
    travelTime: 8,
    description: 'The end of the trail - or the beginning of a new adventure.',
  },
  {
    ...
    lore: {
      founded: '1839',
      peakPopulation: 0,
      historicalNote: 'Sutters Fort stands here. Gold was discovered nearby in 1848.',
      easterEggs: ['Sutter himself laments how gold destroyed his empire'],
    },
    services: ['inn', 'shop', 'stable', 'telegraph'],
    dangerLevel: 'safe',
    connectedTo: ['the_dalles', 'west_point'],
    travelTime: 6,
