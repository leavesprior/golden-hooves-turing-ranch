...
export const GOLD_COUNTRY_LOCATIONS: GoldCountryLocation[] = [
  ...
  {
    id: 'kennedy_mine',
    name: 'The ridge above Jackson',
    shortName: 'The ridge',
    description: '1849: placer on the ridge above Botilleas. Black miners were on this hill first. A hole is being sunk that the claim book does not explain, and a canvas meat stall feeds it. (Later: Kennedy quartz 1856+, company 1860, east shaft 5,912 ft by 1942; Ellis Evans butcher in town by 1850; Swingle Meat 1945 on Kennedy Flat. The 1922 fire that killed 47 was the neighboring Argonaut.)',
    region: 'amador',
    ...
    sites: [
      ...
      { name: 'Swingle Meat Co. — 12640 Kennedy Flat Rd (since 1945)', url: 'https://maps.google.com/?q=Swingle+Meat+Company+12640+Kennedy+Flat+Rd+Jackson+CA' },
    ],
  ...
  },
  {
    ...
    name: 'Jackson',
    shortName: 'Jackson',
    description: '1849: a camp at a spring of empty bottles — Botilleas. Main Street is mud, not brick. Chinese miners are already cutting a way under it. Warrants are a man’s word.',
    region: 'amador',
