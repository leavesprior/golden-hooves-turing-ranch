...
export function ConsensusIndicator() {
  ...
  const config = {
    full: {
      ...
      description: `${consensus.nodesOnline}/${consensus.totalNodes} nodes verified`,
    },
    provisional: {
      ...
      dot: 'bg-yellow-400',
      label: 'Provisional Ledger',
      description: `${consensus.nodesOnline}/${consensus.totalNodes} nodes online`,
    },
    offline: {
      color: 'text-red-400',
      bg: 'bg-red-900/30',
