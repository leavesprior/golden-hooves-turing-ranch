...
const TOWNS: Town[] = [
  ...
  },
  {
    ...
    attractions: [
      ...
      {
        id: 'ac_twain_cabin',
        name: 'Mark Twain\'s Angels Camp Lodging',
        icon: '📚',
        category: 'history',
        description: 'Twain wintered in Angels Camp in 1864-65 and heard the jumping frog story from bartender Ben Coon at the Angels Hotel. (His actual cabin was on Jackass Hill in Tuolumne County, to the south.)',
      ...
      },
      {
        ...
        icon: '⛏️',
        category: 'adventure',
        description: 'Underground mine tour through actual gold-bearing quartz veins, located near Sutter Creek in Amador County - about a 30-minute drive north of Angels Camp. Pan for gold!',
  ...
  },
  {
    ...
    townStory: 'The native camps already knew this pass. Kit Carson named the point in 1844. Canvas and a pack road in 1849. The coffee house, the plaque, and the boardwalks come later.',
    ...
    attractions: [
      {
        ...
        icon: '⛺',
        category: 'adventure',
        description: '1849 is flour, rope, and a road the native camps already knew. Log cabins and mud. The coffee house and the plaque are not from this year.',
      ...
      },
      {
        ...
        icon: '🧭',
        category: 'history',
        description: 'Historical marker commemorating Kit Carson, said to have passed through and named the town in 1844.',
  ...
  },
  {
    ...
    attractions: [
      ...
      },
      {
        ...
        icon: '⚔️',
        category: 'mystery',
        description: 'Site of the 1851 "French War," when American miners used the Foreign Miners Tax as a pretext to drive French miners off their rich claims.',
  ...
  },
  {
    ...
    secretAttractions: [
      {
        id: 'sa_bart_capture',
        name: 'Black Bart Evidence Trail',
        icon: '🎭',
        category: 'mystery',
        description: 'Where the laundry-marked handkerchief from Bart\'s final Calaveras County robbery tied him to his double life. Bart himself was arrested in San Francisco, then brought here for trial.',
  ...
  },
  {
    ...
    attractions: [
      ...
      },
      {
        ...
        icon: '🐸',
        category: 'entertainment',
        description: 'Home of the annual Jumping Frog Jubilee since 1928. The arena hosts the world\'s most famous amphibian athletics.',
      ...
      {
        id: 'ace_ross_saloon',
        name: 'Angels Hotel Bar',
        icon: '🍺',
        category: 'history',
        description: 'The bar where Mark Twain heard the jumping frog story from bartender Ben Coon in the winter of 1864-65. The stone hotel, built in 1855, still stands.',
      ...
      },
      {
        ...
        icon: '📚',
        category: 'history',
        description: 'The restored Mark Twain Cabin - built around the original fireplace and chimney - stands on Jackass Hill in Tuolumne County, south of Angels Camp near Tuttletown, where Twain stayed with the Gillis brothers during his 1864-65 Gold Country winter.',
    ...
    secretAttractions: [
      {
        ...
        insiderTip: 'Stand at the bar corner and read the landmark plaque — this is the room where American literary humor got its start.',
