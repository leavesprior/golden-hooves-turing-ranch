...
const TOWNS: Town[] = [
  {
    ...
    attractions: [
      ...
      },
      {
        ...
        description: 'Heir to one of California\'s earliest theatre traditions - Volcano organized the state\'s first theatre group in 1854. Live performances in a Gold Rush-era setting.',
