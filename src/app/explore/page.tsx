...
const TOWNS: Town[] = [
    ...
    attractions: [
      {
        ...
        icon: '🏨',
        category: 'history',
        description: 'The oldest continuously operating hotel in California, built in 1856. Gold Rush elegance with Victorian furnishings.',
        ...
        duration: '1-2 hours',
        xp: 30,
        badge: { id: 'historic_lodger', name: 'Historic Lodger', icon: '🏨', description: 'Visited California\'s oldest hotel', rarity: 'uncommon' },
      },
      {
        id: 'nc_firehouse',
      ...
      },
      {
        ...
        icon: '🎭',
        category: 'entertainment',
        description: 'The oldest existing theater building in California, opened in 1865. Mark Twain performed here.',
    ...
    attractions: [
      {
        ...
        funFact: 'The Empire Mine\'s 367 miles of underground tunnels would stretch from San Francisco to Los Angeles. At 5,912 feet deep, it was the deepest mine in North America.',
  ...
  },
  {
    ...
    townStory: 'Founded in 1848 by George Angel, a soldier turned merchant. Angels Camp became a literary landmark when Mark Twain wintered here in 1864-65 and heard the jumping frog tale at Ross\'s Saloon that became his first major published work. The town celebrates with an annual Frog Jump that draws competitors worldwide.',
    coordinates: { lat: 38.0684, lng: -120.5394 },
    attractions: [
      {
        id: 'ace_museum',
      ...
      {
        id: 'ace_ross_saloon',
        name: 'Ross\'s Saloon Site',
        icon: '🍺',
        category: 'history',
        description: 'The site where Mark Twain heard the jumping frog story from bartender Ben Coon in the winter of 1864-65.',
        ...
        insiderTip: 'The original building is gone, but a historic marker identifies the spot. Combine with a visit to the Angels Hotel site nearby.',
        duration: '30 min',
        xp: 20,
      },
      {
    ...
    secretAttractions: [
      {
        id: 'ace_angels_hotel',
        name: 'Angels Hotel Foundation',
        icon: '🔍',
        category: 'mystery',
        description: 'The stone foundation of the original Angels Hotel where Twain stayed. Hidden behind modern buildings.',
        ...
        insiderTip: 'Access is from the alley behind Main Street. Look for the interpretive sign near the stone walls.',
        secretUnlock: 'Visit Ross\'s Saloon Site AND the Museum',
        duration: '30 min',
        xp: 50,
