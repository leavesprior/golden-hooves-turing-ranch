  ...
  },
  {
    ...
    attractions: [
      ...
      },
      {
        ...
        funFact: 'Twain almost didn\'t write the story. He called it "a villainous backwoods sketch" and submitted it as a last resort — it made him famous overnight.',
      ...
      {
        id: 'ace_twain_cabin',
        name: 'Mark Twain Cabin Replica',
        icon: '📚',
        category: 'history',
        description: 'Replica of the cabin where Twain stayed during his Gold Country sojourn. Contains period furnishings and Twain quotes.',
        funFact: 'Twain was broke and hiding from creditors when he came to Angels Camp. He was supposed to be gold mining but spent most of his time listening to stories.',
        insiderTip: 'The cabin replica is at the museum grounds. Read the Twain journal entries posted inside — his complaints about the weather are hilarious.',
        duration: '30 min',
        xp: 20,
