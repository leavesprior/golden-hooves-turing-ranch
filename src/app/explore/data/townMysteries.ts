...
export const TOWN_MYSTERIES: TownMystery[] = [
  ...
  // === KENNEDY MINE ===
  {
    id: 'kennedy_disaster',
    townId: 'kennedy_mine',
    title: 'The Bulkhead Between the Mines',
    briefing: 'On August 27, 1922, fire broke out deep in the ARGONAUT Mine — the Kennedy\'s neighbor in Jackson — trapping 47 men far underground. For three weeks rescuers tunneled toward them from the connected Kennedy Mine, but a bulkhead and bad air stood in the way. Why did none of the 47 come out alive?',
    era: '1922',
    difficulty: 'hard',
    clues: [
      {
        ...
        text: 'The Kennedy Mine headframe towers over the site. A placard reads: "At 5,912 feet, the Kennedy was the deepest gold mine in the United States. Its workings connected underground to the neighboring Argonaut Mine — a link that made the Kennedy the rescuers\' only road to the Argonaut\'s trapped men in 1922."',
      ...
      },
      {
        ...
        text: 'Inquest record: "The fire began the night of August 27, 1922, in the Argonaut shaft. Forty-seven men were working the 4,650-foot level. The single hoisting shaft filled with smoke and gas; with no second way out, the men were cut off below the fire."',
        discoveryText: 'In the museum, the 1922 inquest documents are archived...',
        required: true,
        order: 2,
      },
      {
        ...
        text: 'A rescue-effort timeline: "For three weeks, crews drove a tunnel from the Kennedy\'s workings toward the Argonaut\'s trapped men, then had to breach a bulkhead between the mines. When they finally broke through in October, all 47 were long dead — they had built a bulkhead of their own against the gas, but it was not enough."',
      ...
      },
      {
        ...
        text: 'The memorial lists the 47 dead — mostly Italian, Spanish, and Serbian immigrant miners. A historian\'s note: "It remains the deadliest gold-mine disaster in California history. The inquiry centered on the lack of a second escape way and on whether the bulkhead between Argonaut and Kennedy slowed the rescue. New mine-safety rules followed."',
    ...
    deduction: {
      question: 'Why did all 47 Argonaut miners die despite a three-week rescue from the Kennedy Mine?',
      options: [
        { id: 'a', text: 'The fire collapsed the entire mine instantly', correct: false, response: 'The fire did not collapse the mine — the men survived the initial blaze and even built a bulkhead against the gas. They were not crushed; they were cut off.' },
        { id: 'b', text: 'The mine had a single shaft / no second escape way, and the fire-and-gas plus the bulkhead between the mines made rescue too slow', correct: true, response: 'Correct! The Argonaut\'s men were trapped below a fire in a mine with effectively one way out. Smoke and gas filled the single shaft, so escape upward was impossible. Rescuers had to tunnel from the connected Kennedy Mine and breach a bulkhead between the two — a three-week effort. By the time they broke through in October, all 47 had died of gas behind a barricade they\'d built themselves. The disaster drove new laws requiring a second escape way in deep mines.' },
        { id: 'c', text: 'The lower levels flooded faster than the men could climb out', correct: false, response: 'A common misremembering — but the 1922 Argonaut disaster was a FIRE, not a flood. The men died of gas behind the fire, not drowning.' },
        { id: 'd', text: 'Rescuers were ordered to stop digging to protect company property', correct: false, response: 'No — the rescue ran for three weeks across two mines. The barrier was physical (fire, gas, the bulkhead and the distance), not a company order to quit.' },
      ],
      minCluesRequired: 3,
    },
    xpReward: 150,
    badgeId: 'mystery_kennedy_mine',
    solvedText: 'The 47 of the Argonaut died not of flood but of fire and gas, behind a bulkhead, while rescuers dug toward them from the Kennedy for three weeks.',
    historicalNote: 'The Argonaut Mine fire of August 27, 1922 in Jackson, California killed 47 miners — mostly Italian, Spanish, and Serbian immigrants — trapped at about the 4,650-foot level when fire and gas filled the single shaft. Rescuers spent three weeks tunneling from the adjacent (and deeper) Kennedy Mine, the deepest gold mine in the United States at 5,912 feet, and breaching a bulkhead between the two; all 47 had died. It remains the deadliest gold-mine disaster in California history and led to mine-safety reforms, including second-escapeway requirements. The Kennedy and Argonaut are California Historical Landmark #786.',
  },
